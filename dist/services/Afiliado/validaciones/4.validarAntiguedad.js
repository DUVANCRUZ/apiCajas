...
const validarAntiguedad = (afiliado) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const convenio = yield Convenio_1.default.findOne({
...
exports.default = validarAntiguedad;
